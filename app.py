...
with gr.Blocks() as demo:
    ...
    gr.HTML(value=f"<justify><font size='4'> Welcome to the pediatric brain tumor segmenter. Please read the <a href='https://precision-medical-imaging-group.github.io/HAIL-Segmenter-Kids'>instructions</a> before using the application. </font></justify>")
    with gr.Row():
